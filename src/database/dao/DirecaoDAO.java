...
public class DirecaoDAO {
    ...
    private static final String SQL_SELECT_BY_PROCESSO_HABILITADO = "SELECT * FROM TB_REPLICACAO_DIRECAO WHERE PROCESSO_ID = ? AND HABILITADO = TRUE";
    ...
    private static final String SQL_INSERT = "INSERT INTO TB_REPLICACAO_DIRECAO (PROCESSO_ID, DIRECAO_ORIGEM, DIRECAO_DESTINO, USUARIO_ORIGEM, USUARIO_DESTINO, SENHA_ORIGEM, SENHA_DESTINO, HABILITADO) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";

    private static final String SQL_UPDATE = "UPDATE TB_REPLICACAO_DIRECAO SET PROCESSO_ID = ?, DIRECAO_ORIGEM = ?, DIRECAO_DESTINO = ?, USUARIO_ORIGEM = ?, USUARIO_DESTINO = ?, SENHA_ORIGEM = ?, SENHA_DESTINO = ?, HABILITADO = ? WHERE ID = ?";
